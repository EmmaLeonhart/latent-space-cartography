...
- Step 2: add second seed — `import_wikidata.py --instances Q6256 --limit 300` P31 country-level sampling into the same store (running in background; matches the paper's two-seed design).
